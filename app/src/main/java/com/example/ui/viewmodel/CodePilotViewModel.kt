...
data class CodePilotUiState(
    ...
    val isManualAnalyseOpen: Boolean = false,
    val manualAnalyseInitialTab: Int = 0,
...
class CodePilotViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun setManualAnalyseOpen(isOpen: Boolean, initialTab: Int = 0) {
        _uiState.update { it.copy(isManualAnalyseOpen = isOpen, manualAnalyseInitialTab = initialTab) }
    }
    ...
    // PRIMARY PRODUCT FLOW: process response from AI Studio or paste
